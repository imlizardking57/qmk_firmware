...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_DEFLT] = LAYOUT( \
        ...
        KC_LCTL, KC_LGUI, TD(TD_LALT) , MO(_FN), MO(_LOWER),KC_SPC,KC_SPC,MO(_RAISE),KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT       \
    ),

	
    [_RAISE] = LAYOUT( \
       KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  \
       _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_INSERT, KC_PGUP, KC_PSCR, KC_BRIU,  \
       _______, _______, _______, _______, _______, _______, _______, KC_END , KC_DELETE, KC_PGDOWN, KC_PAUSE, KC_BRID,  \
       _______, _______, _______, _______, _______, _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, KC_MSTP,  \
    ...
    [_LOWER] = LAYOUT( \
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, RGB_HUI, RGB_SAI, RGB_VAI, RGB_TOG, \
    ...
    [_FN] = LAYOUT( \
       ...
       KC_LCTL, KC_LGUI, KC_LALT, _______, _______, _______, _______, _______, KC_P0, KC_PDOT, _______, MYRGB_TG    \
    )
};
